...
namespace C3Mod.GameTypes
{
	internal class TDM
	{
		...
		public static void OnUpdate(EventArgs args)
		{
			lock (C3Mod.C3Players)
			{
				if (C3Mod.VoteRunning && (C3Mod.VoteType == "tdm"))
				{
					...
					{
						C3Tools.BroadcastMessageToGametype("tdm", "Vote to play Team Deathmatch passed, Teleporting to start positions",
							Color.DarkCyan);
					...
					if ((tick > C3Mod.C3Config.VoteNotifyInterval * 1000) && (VoteCount > 0))
					{
						if ((VoteCount != 1) && (VoteCount < C3Mod.C3Config.VoteTime / C3Mod.C3Config.VoteNotifyInterval))
						{
							...
							C3Tools.BroadcastMessageToGametype("", "Vote to play Team Deathmatch in progress, type /join to join the lobby",
								Color.Cyan);
						}
					...
					else if (VoteCount == 0)
					{
						...
						{
							C3Tools.BroadcastMessageToGametype("tdm", "Vote to play Team Deathmatch failed, Not enough players",
								Color.DarkCyan);
						...
						switch (C3Mod.C3Config.TeamColor1)
						{
							case 1:
							{
								if (C3Mod.C3Config.TeamColor2 == 2)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Red - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 3)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Red - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 4)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Red - " + Team1Score + " --- " + Team2Score + " - Yellow", Color.Cyan);
								break;
							}
							case 2:
							{
								if (C3Mod.C3Config.TeamColor2 == 1)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Green - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 3)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Green - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 4)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Green - " + Team1Score + " --- " + Team2Score + " - Yellow", Color.Cyan);
								break;
							}
							case 3:
							{
								if (C3Mod.C3Config.TeamColor2 == 1)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 2)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 4)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
								break;
							}
							case 4:
							{
								if (C3Mod.C3Config.TeamColor2 == 1)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 2)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
								else if (C3Mod.C3Config.TeamColor2 == 3)
									C3Tools.BroadcastMessageToGametype("tdm",
										"Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
								break;
							}
						}
		...
		public static int TpToSpawnPoint()
		{
			try
			{
				var RedTeamPlayer = false;
				var BlueTeamPlayer = false;
