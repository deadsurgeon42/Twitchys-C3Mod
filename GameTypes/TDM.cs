...
namespace C3Mod.GameTypes
{
  internal class TDM
  {
    ...
    public static bool TDMRunning;
    public static bool TDMCountdown;
        ...
        if (TDMCountdown)
        {
          ...
          if (tick > 1000 && StartCount > -1)
          {
            if (TpToSpawnPoint() > 0)
            {
              ...
              {
                C3Tools.BroadcastMessageToGametype("tdm", "Game starting in " + StartCount + "...", Color.Cyan);
                countDownTick = DateTime.UtcNow;
                StartCount--;
              }
            }
              ...
              case 1:
                {
                  if (C3Mod.C3Config.TeamColor2 == 2)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Red - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 3)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Red - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 4)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Red - " + Team1Score + " --- " + Team2Score + " - Yellow", Color.Cyan);
                  break;
                }
              case 2:
                {
                  if (C3Mod.C3Config.TeamColor2 == 1)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Green - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 3)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Green - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 4)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Green - " + Team1Score + " --- " + Team2Score + " - Yellow", Color.Cyan);
                  break;
                }
              case 3:
                {
                  if (C3Mod.C3Config.TeamColor2 == 1)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 2)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 4)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Blue - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
                  break;
                }
              case 4:
                {
                  if (C3Mod.C3Config.TeamColor2 == 1)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Red", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 2)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Green", Color.Cyan);
                  else if (C3Mod.C3Config.TeamColor2 == 3)
                    C3Tools.BroadcastMessageToGametype("tdm", "Current score: Yellow - " + Team1Score + " --- " + Team2Score + " - Blue", Color.Cyan);
                  break;
                }
            }
