                    ...
                    case 1:
                      {
                        if (C3Mod.C3Config.TeamColor2 == 2)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team1Score + " --- " + Team2Score + " - Green", Color.OrangeRed);
                        else if (C3Mod.C3Config.TeamColor2 == 3)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team1Score + " --- " + Team2Score + " - Blue", Color.OrangeRed);
                        else if (C3Mod.C3Config.TeamColor2 == 4)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team1Score + " --- " + Team2Score + " - Yellow", Color.OrangeRed);
                        break;
                      }
                    case 2:
                      {
                    ...
                    case 1:
                      {
                        if (C3Mod.C3Config.TeamColor1 == 2)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Green", Color.OrangeRed);
                        else if (C3Mod.C3Config.TeamColor1 == 3)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Blue", Color.OrangeRed);
                        else if (C3Mod.C3Config.TeamColor1 == 4)
                          C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Yellow", Color.OrangeRed);
                        break;
                      }
                    case 2:
                      {
