          ...
          if (TpToSpawnPoint() > 0)
          {
            ...
            else
            {
              ...
              switch (r.Next(20) + 1)
              {
                ...
                case 5:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "Are you ready? No. Wave starting in: " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 6:
                  {
                ...
                case 7:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "Once upon a time.. You died. Wave starting in: " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 8:
                  {
                ...
                case 11:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "Twitchy is awesome! Wave starting in: " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 12:
                  {
                ...
                case 13:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "It hurts ok? Dont believe otherwise! Pain in: " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 14:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "Fun in: " + (StartCount * 5) + ".... Oh wait. Nvm. You'll find out.", Color.Cyan);
                    break;
                  }
                case 15:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "MWAHAHAHA. Oh, hi there. Ignore that... " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 16:
                  {
                ...
                case 17:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "Peanut butter. Best cure for all cuts and bruises " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
                case 19:
                  {
                ...
                case 20:
                  {
                    C3Tools.BroadcastMessageToGametype("apoc", "C3 Apocalypse. Leading the way since 2010! " + (StartCount * 5) + "...", Color.Cyan);
                    break;
                  }
              }
          ...
          foreach (C3Player player in C3Mod.C3Players)
          {
            if (player.GameType == "apoc")
            {
              ...
              if (Main.player[player.Index].dead)
              {
                ...
                {
                  player.SendMessage("Lives left: " + (C3Mod.C3Config.MonsterApocalypseLivesPerWave - player.LivesUsed), Color.Cyan);
