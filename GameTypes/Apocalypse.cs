...
namespace C3Mod.GameTypes
{
	internal class Apocalypse
	{
		...
		public static NPC CurMonster;
		public static Vector2 SpectatorArea;
		public static Vector2 PlayerSpawn;
		public static Vector2 MonsterSpawn;
		...
		public static void OnUpdate(EventArgs args)
		{
			if (C3Mod.VoteRunning && (C3Mod.VoteType == "apoc"))
			{
				...
				{
					C3Tools.BroadcastMessageToGametype("apoc", "Vote to play Monster Apocalypse passed, Teleporting to start positions",
						Color.DarkCyan);
				...
				if ((tick > C3Mod.C3Config.VoteNotifyInterval * 1000) && (VoteCount > 0))
				{
					if ((VoteCount != 1) && (VoteCount < C3Mod.C3Config.VoteTime / C3Mod.C3Config.VoteNotifyInterval))
					{
						...
						C3Tools.BroadcastMessageToGametype("", "Vote to play Monster Apocalypse in progress, type /join to join the lobby",
							Color.Cyan);
					}
				...
				else if (VoteCount == 0)
				{
					...
					{
						C3Tools.BroadcastMessageToGametype("apoc",
							"Vote to play Monster Apocalypse passed, Teleporting to start positions", Color.DarkCyan);
						var playersDead = new bool[Main.maxNetPlayers];
						TpToSpawnPoint();
						countDownTick = DateTime.UtcNow;
						Intermission = true;
					...
					C3Tools.BroadcastMessageToGametype("apoc", "Vote to play Monster Apocalypse failed, Not enough players",
						Color.DarkCyan);
				}
			}
					...
					if (TpToSpawnPoint() > 0)
					{
						...
						else
						{
							...
							switch (r.Next(20) + 1)
							{
								case 1:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Apocalypse in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 2:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "World's demise in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 3:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "You are dead in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 4:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Goodbye. Wave starting in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 5:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Are you ready? No. Wave starting in: " + StartCount * 5 + "...",
										Color.Cyan);
									break;
								}
								case 6:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "DOOOM! Wave starting in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 7:
								{
									C3Tools.BroadcastMessageToGametype("apoc",
										"Once upon a time.. You died. Wave starting in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 8:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "The year 2012 in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 9:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Space Ship's Leaving in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 10:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Rawr! Wave starting in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 11:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Twitchy is awesome! Wave starting in: " + StartCount * 5 + "...",
										Color.Cyan);
									break;
								}
								case 12:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Umm... " + StartCount * 5 + " till...death?", Color.Cyan);
									break;
								}
								case 13:
								{
									C3Tools.BroadcastMessageToGametype("apoc",
										"It hurts ok? Dont believe otherwise! Pain in: " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 14:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Fun in: " + StartCount * 5 + ".... Oh wait. Nvm. You'll find out.",
										Color.Cyan);
									break;
								}
								case 15:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "MWAHAHAHA. Oh, hi there. Ignore that... " + StartCount * 5 + "...",
										Color.Cyan);
									break;
								}
								case 16:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "The Twitchy god spites you! " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 17:
								{
									C3Tools.BroadcastMessageToGametype("apoc",
										"Peanut butter. Best cure for all cuts and bruises " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 19:
								{
									C3Tools.BroadcastMessageToGametype("apoc", "Hehehe... " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
								case 20:
								{
									C3Tools.BroadcastMessageToGametype("apoc",
										"C3 Apocalypse. Leading the way since 2010! " + StartCount * 5 + "...", Color.Cyan);
									break;
								}
							}
			...
			if (Running)
			{
				...
				{
					C3Tools.BroadcastMessageToGametype("apoc", CurMonster.name + "'s Left: " + MonstersLeft, Color.Cyan);
				...
				if (MonstersLeft == 0)
				{
					...
					ChooseNPC();
					Wave++;
					var AlivePlayers = new List<C3Player>();
					var SpecatingPlayers = new List<C3Player>();
				...
				foreach (var npc in MonsterWhoAmI)
					if (!npc.active)
					{
					...
					foreach (var player in C3Mod.C3Players)
						if (player.GameType == "apoc")
						{
							...
							if (Main.player[player.Index].dead)
							{
								...
								{
									player.SendMessage("Lives left: " + (C3Mod.C3Config.MonsterApocalypseLivesPerWave - player.LivesUsed),
										Color.Cyan);
