		...
		public static void OnUpdate(EventArgs args)
		{
			lock (C3Mod.C3Players)
			{
				if (C3Mod.VoteRunning && (C3Mod.VoteType == "ctf"))
				{
					...
					{
						C3Tools.BroadcastMessageToGametype("ctf", "Vote to play Capture the Flag passed, Teleporting to start positions",
							Color.DarkCyan);
					...
					if ((tick > C3Mod.C3Config.VoteNotifyInterval * 1000) && (VoteCount > 0))
					{
						if ((VoteCount != 1) && (VoteCount < C3Mod.C3Config.VoteTime / C3Mod.C3Config.VoteNotifyInterval))
						{
							...
							C3Tools.BroadcastMessageToGametype("", "Vote to play Capture the Flag in progress, type /join to join the lobby",
								Color.Cyan);
						}
					...
					else if (VoteCount == 0)
					{
						...
						if ((team1players >= C3Mod.C3Config.VoteMinimumPerTeam) && (team2players >= C3Mod.C3Config.VoteMinimumPerTeam))
						{
							...
							C3Tools.BroadcastMessageToGametype("ctf", "Vote to play Capture the Flag failed, Not enough players",
								Color.DarkCyan);
					}
				}
				...
				if (CTFGameRunning)
				{
					...
					{
						C3Tools.BroadcastMessageToGametype("ctf", "Capture the Flag stopped, Not enough players to continue",
							Color.DarkCyan);
					...
					if (Team2FlagCarrier != null)
						...
						{
							if (((int) Team2FlagCarrier.tileX >= flagPoints[1].X - 2) &&
							    ((int) Team2FlagCarrier.tileX <= flagPoints[1].X + 2) &&
							    ((int) Team2FlagCarrier.tileY == (int) (flagPoints[1].Y - 3)))
							{
								Team2Score++;
								switch (C3Mod.C3Config.TeamColor2)
								{
									case 1:
									{
										switch (C3Mod.C3Config.TeamColor1)
										{
											case 2:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Green",
													Color.OrangeRed);
												break;
											case 3:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Blue",
													Color.OrangeRed);
												break;
											case 4:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Yellow",
													Color.OrangeRed);
												break;
											case 5:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Red - " + Team2Score + " --- " + Team1Score + " - Pink",
													Color.OrangeRed);
												break;
										}
										break;
									...
									case 2:
									{
										switch (C3Mod.C3Config.TeamColor1)
										{
											case 1:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Green - " + Team2Score + " --- " + Team1Score + " - Red",
													Color.Green);
												break;
											case 3:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Green - " + Team2Score + " --- " + Team1Score + " - Blue",
													Color.Green);
												break;
											case 4:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Green - " + Team2Score + " --- " + Team1Score + " - Yellow",
													Color.Green);
												break;
											case 5:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Green - " + Team2Score + " --- " + Team1Score + " - Pink",
													Color.Green);
												break;
										}
										break;
									...
									case 3:
									{
										switch (C3Mod.C3Config.TeamColor1)
										{
											case 1:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score + " --- " + Team1Score + " - Red",
													Color.Blue);
												break;
											case 2:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score + " --- " + Team1Score + " - Green",
													Color.Blue);
												break;
											case 4:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score + " --- " + Team1Score + " - Yellow",
													Color.Blue);
												break;
											case 5:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score + " --- " + Team1Score + " - Pink",
													Color.Blue);
												break;
										}
										break;
									...
									case 4:
									{
										switch (C3Mod.C3Config.TeamColor1)
										{
											case 1:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Yellow - " + Team2Score + " --- " + Team1Score + " - Red",
													Color.Yellow);
												break;
											case 2:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Yellow - " + Team2Score + " --- " + Team1Score + " - Green",
													Color.Yellow);
												break;
											case 3:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Yellow - " + Team2Score + " --- " + Team1Score + " - Blue",
													Color.Yellow);
												break;
											case 5:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Yellow - " + Team2Score + " --- " + Team1Score + " - Pink",
													Color.Yellow);
												break;
										}
										break;
									...
									case 5:
									{
										switch (C3Mod.C3Config.TeamColor1)
										{
											case 1:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Pink - " + Team2Score + " --- " + Team1Score + " - Red",
													Color.Pink);
												break;
											case 2:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Pink - " + Team2Score + " --- " + Team1Score + " - Green",
													Color.Pink);
												break;
											case 3:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Pink - " + Team2Score + " --- " + Team1Score + " - Blue",
													Color.Pink);
												break;
											case 4:
												C3Tools.BroadcastMessageToGametype("ctf",
													Team2FlagCarrier.PlayerName + ": Scores!  Pink - " + Team2Score + " --- " + Team1Score + " - Yellow",
													Color.Pink);
												break;
										}
										break;
					...
					if (Team1FlagCarrier != null)
						...
						{
							if (((int) Team1FlagCarrier.tileX >= flagPoints[0].X - 2) &&
							    ((int) Team1FlagCarrier.tileX <= flagPoints[0].X + 2) &&
							    ((int) Team1FlagCarrier.tileY == (int) (flagPoints[0].Y - 3)))
							{
								Team1Score++;
								switch (C3Mod.C3Config.TeamColor1)
								{
			...
			try
			{
				...
				for (var i = 0; i < C3Mod.C3Players.Count; i++)
				{
					...
					if (C3Mod.C3Players[i].Team == 1)
					{
						...
						{
							if (((int) C3Mod.C3Players[i].TSPlayer.X / 16 != (int) spawnPoints[0].X) ||
							    ((int) C3Mod.C3Players[i].TSPlayer.Y / 16 != (int) spawnPoints[0].Y))
								TShock.Players[C3Mod.C3Players[i].Index].Teleport((int) spawnPoints[0].X * 16, (int) spawnPoints[0].Y * 16);
						}
						else if (((int) C3Mod.C3Players[i].TSPlayer.X / 16 != (int) spawnPoints[0].X) ||
						         ((int) C3Mod.C3Players[i].TSPlayer.Y / 16 != (int) spawnPoints[0].Y))
							TShock.Players[C3Mod.C3Players[i].Index].Teleport((int) spawnPoints[0].X * 16, (int) spawnPoints[0].Y * 16);
					...
					if (C3Mod.C3Players[i].Team == 2)
					{
						...
						{
							if (((int) C3Mod.C3Players[i].TSPlayer.X / 16 != (int) flagPoints[1].X) ||
							    ((int) C3Mod.C3Players[i].TSPlayer.Y / 16 != (int) flagPoints[1].Y))
								TShock.Players[C3Mod.C3Players[i].Index].Teleport((int) flagPoints[1].X * 16, (int) flagPoints[1].Y * 16);
						}
						else if (((int) C3Mod.C3Players[i].TSPlayer.X / 16 != (int) spawnPoints[1].X) ||
						         ((int) C3Mod.C3Players[i].TSPlayer.Y / 16 != (int) spawnPoints[1].Y))
