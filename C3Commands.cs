  ...
  internal class C3Commands
  {
    ...
    public static void AddCTFArena(CommandArgs args)
    {
      if (args.Parameters.Count > 0)
      {
        ...
        if ((player.tempflags[0] != new Vector2()) && (player.tempflags[1] != new Vector2()) &&
            (player.tempspawns[0] != new Vector2()) && (player.tempspawns[1] != new Vector2()))
        {
          var text = "";
    ...
    public static void AddOneFlagArena(CommandArgs args)
    {
      if (args.Parameters.Count > 0)
      {
        ...
        if ((player.tempflags[0] != new Vector2()) && (player.tempspawns[0] != new Vector2()) &&
            (player.tempspawns[1] != new Vector2()))
        {
          var text = "";
    ...
    public static void ChallengePlayer(CommandArgs args)
    {
      ...
      if (args.Parameters.Count > 0)
      {
        ...
        if (!int.TryParse(args.Parameters[0], out arena))
        {
          arena = 1;
        ...
        {
          arena = int.Parse(args.Parameters[0]);
                ...
                if ((challenging = C3Tools.GetC3PlayerByName(name.ToLower())) != null)
                  if (challenging.GameType == "")
                  {
                    ...
                    args.Player.SendMessage(
                      "Challenge has been made to: " + challenging.PlayerName + ", Arena: " +
                      Duel.Arenas[arena - 1].Name, Color.Cyan);
                  }
                  else
                    args.Player.SendMessage(challenging.PlayerName + ": Is unavailable to be challenged at this time",
                      Color.DarkCyan);
                else
    ...
    public static void AcceptChallenge(CommandArgs args)
    {
      ...
      foreach (var opponent in C3Mod.C3Players)
    ...
    #endregion Voting and Game Administration
    ...
    {
      if (args.Parameters.Count > 0)
        if (int.TryParse(args.Parameters[0], out C3Mod.C3Config.CTFScoreLimit))
        {
    ...
    {
      if (args.Parameters.Count > 0)
        if (int.TryParse(args.Parameters[0], out C3Mod.C3Config.OneFlagScorelimit))
        {
          C3Mod.C3Config.Write(C3Tools.C3ConfigPath);
          args.Player.SendMessage("Score limit set successfully!", Color.Cyan);
        }
    ...
    {
      if (args.Parameters.Count > 0)
        if (int.TryParse(args.Parameters[0], out C3Mod.C3Config.DuelScoreLimit))
        {
          C3Mod.C3Config.Write(C3Tools.C3ConfigPath);
          args.Player.SendMessage("Score limit set successfully!", Color.Cyan);
        }
    ...
    {
      if (args.Parameters.Count > 0)
        if (int.TryParse(args.Parameters[0], out C3Mod.C3Config.TeamDeathmatchScorelimit))
        {
          C3Mod.C3Config.Write(C3Tools.C3ConfigPath);
          args.Player.SendMessage("Score limit set successfully!", Color.Cyan);
        }
    ...
    {
      if (args.Parameters.Count > 0)
        if (int.TryParse(args.Parameters[0], out C3Mod.C3Config.FFAScorelimit))
        {
          C3Mod.C3Config.Write(C3Tools.C3ConfigPath);
          args.Player.SendMessage("Score limit set successfully!", Color.Cyan);
        }
